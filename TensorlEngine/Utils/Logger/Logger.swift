...
open class TSLogger {
    ...
    public static func log(_ level: TSLogLevel, file: String = #file, function: String = #function, line: Int = #line, _ message: String = "") {
    ...
    private static func printToConsole(logLevel: TSLogLevel, file: String, function: String, line: Int, message: String) {
        #if DEBUG
